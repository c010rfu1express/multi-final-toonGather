...
public interface CsService {
    ...
    boolean updateQuestion(QuestionDTO question, List<String> existingImages, List<String> removedImages, MultipartFile[] images, HttpServletRequest request) throws Exception;
